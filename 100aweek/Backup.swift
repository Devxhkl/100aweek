...
class Backup: NSManagedObject {
    ...
    class func createBackup(managedObjectContext: NSManagedObjectContext, _id: String, _lastStartInterval: NSNumber, _active: NSNumber, _activeTime: NSNumber, _pauseTime: NSNumber) -> Backup {
